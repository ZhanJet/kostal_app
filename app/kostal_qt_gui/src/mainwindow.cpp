...
void MainWindow::updateRobotData(const kostal_gui_msgs::msg::KostalLever *subscribedMsg)
{
    ...
    case 105:
        ...
        ui->robot_status->setStyleSheet(QString("QLabel{background-color:%1;color:%2;font-size:20px;border:1px solid #909090;border-radius:5px;}").arg("#6D6D6D").arg("#285780"));
        break;
    case 106:
        ui->robot_status->setText(tr("106"));
        ui->robot_status->setStyleSheet(QString("QLabel{background-color:%1;color:%2;font-size:20px;border:1px solid #909090;border-radius:5px;}").arg("#FF0000").arg("#285780"));
        break;
    case 107:
        ui->robot_status->setText(tr("107"));
        ui->robot_status->setStyleSheet(QString("QLabel{background-color:%1;color:%2;font-size:20px;border:1px solid #909090;border-radius:5px;}").arg("#00FF00").arg("#285780"));
        break;
    case 108:
        ui->robot_status->setText(tr("108"));
        ui->robot_status->setStyleSheet(QString("QLabel{background-color:%1;color:%2;font-size:20px;border:1px solid #909090;border-radius:5px;}").arg("#FFFF00").arg("#285780"));
        break;
    default:
        ui->robot_status->setText("");
        ui->robot_status->setStyleSheet(QString("QLabel{background-color:%1;color:%2;font-size:20px;border:1px solid #909090;border-radius:5px;}").arg("#FFFFFF").arg("#285780"));
        break;
    }
...
void MainWindow::updateSpiData(const kostal_gui_msgs::msg::KostalLever *subscribedMsg)
{
    ...
    case 109:
        ...
        ui->spi_status->setStyleSheet(QString("QLabel{background-color:%1;color:%2;font-size:20px;border:1px solid #909090;border-radius:5px;}").arg("#6D6D6D").arg("#285780"));
        break;
    case 110:
        ui->spi_status->setText(tr("110"));
        ui->spi_status->setStyleSheet(QString("QLabel{background-color:%1;color:%2;font-size:20px;border:1px solid #909090;border-radius:5px;}").arg("#FF0000").arg("#285780"));
        break;
    case 111:
        ui->spi_status->setText(tr("111"));
        ui->spi_status->setStyleSheet(QString("QLabel{background-color:%1;color:%2;font-size:20px;border:1px solid #909090;border-radius:5px;}").arg("#00FF00").arg("#285780"));
        break;
    case 112:
        ui->spi_status->setText(tr("112"));
        ui->spi_status->setStyleSheet(QString("QLabel{background-color:%1;color:%2;font-size:20px;border:1px solid #909090;border-radius:5px;}").arg("#FFFF00").arg("#285780"));
        break;
    default:
        ui->spi_status->setText("");
        ui->spi_status->setStyleSheet(QString("QLabel{background-color:%1;color:%2;font-size:20px;border:1px solid #909090;border-radius:5px;}").arg("#FFFFFF").arg("#285780"));
        break;
    }
...
void MainWindow::updateTestmanData(const kostal_gui_msgs::msg::KostalLever *subscribedMsg)
{
    ...
    case 101:
        ...
        ui->testman_status->setStyleSheet(QString("QLabel{background-color:%1;color:%2;font-size:20px;border:1px solid #909090;border-radius:5px;}").arg("#6D6D6D").arg("#285780"));
        break;
    case 102:
        ui->testman_status->setText(tr("102"));
        ui->testman_status->setStyleSheet(QString("QLabel{background-color:%1;color:%2;font-size:20px;border:1px solid #909090;border-radius:5px;}").arg("#FF0000").arg("#285780"));
        break;
    case 103:
        ui->testman_status->setText(tr("103"));
        ui->testman_status->setStyleSheet(QString("QLabel{background-color:%1;color:%2;font-size:20px;border:1px solid #909090;border-radius:5px;}").arg("#00FF00").arg("#285780"));
        break;
    case 104:
        ui->testman_status->setText(tr("104"));
        ui->testman_status->setStyleSheet(QString("QLabel{background-color:%1;color:%2;font-size:20px;border:1px solid #909090;border-radius:5px;}").arg("#FFFF00").arg("#285780"));
        break;
    default:
        ui->testman_status->setText("");
        ui->testman_status->setStyleSheet(QString("QLabel{background-color:%1;color:%2;font-size:20px;border:1px solid #909090;border-radius:5px;}").arg("#FFFFFF").arg("#285780"));
        break;
    }
...
void MainWindow::on_actionRestart_Robot_triggered()
{
    ...
    runProcess->start("sh /home/kostal/Programs/Kostal/flexiv_app_guis/app/kostal_qt_gui/run_rdk.sh");
